...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		String myName = "Nicholas Weller";
		System.out.println(myName);
		
		/*
		8. Create and set a variable that holds the number of buttons on your mouse.
		*/
		int numberOfMouseButtons = 4;
		...
		*/
		String myFullName = "Nicholas Bruce Weller";
		...
		*/
		...
		the same variable.
		*/
		String myFullNameLawyer = myFullName + ", Esquire";
		System.out.println(myFullNameLawyer);
