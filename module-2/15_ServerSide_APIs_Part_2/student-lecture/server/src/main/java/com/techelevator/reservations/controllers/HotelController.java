...
public class HotelController {
	...
	public Reservation updateReservation(@Valid @RequestBody Reservation changedReservation, @PathVariable int id)
			throws ReservationNotFoundException {
		return reservationDAO.update(changedReservation, id);
	}
