...
Navigate to `src/main/java/com/techelevator/locations` right-click on the `LocationsApplication.java` and select `Run As > Java Application`. Some logging appears in the Console. The last line tells you that the application has started.
